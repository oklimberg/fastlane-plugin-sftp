  ...
  module Actions
    class SftpUploadAction < Action
      def self.run(params)
        ...
        FastlaneCore::PrintTable.print_values(config: params, mask_keys: [:server_password, :server_key, :server_key_passphrase, :server_port], title: "SFTP Upload #{Sftp::VERSION} Summary")
